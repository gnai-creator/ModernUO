...
namespace Server.Mobiles
{
    public class HelpGump : Gump
    {
            ...
            : base(X, Y)
        {
            ...
            AddLabel(27, 2, 0x384, "Standalone Keywords NB: ( « equivale a < ) ( » equivale a > )");
            AddHtml(25, 20, width - 10, 440,
                "mobtype[,argomento1,argomento2,...]\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=407\">SET[,nomeitem o seriale][,itemtype]/proprietà/valore/...</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=408\">SETONMOB,nomemob[,mobtype]/proprietà/valore/...</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=409\">SETONTHIS[,proptest]/proprietà/valore/...</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=410\">SETONTRIGMOB/proprietà/valore/...</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=411\">SETVAR,nomevar,valore[,durata] (STRINGHE)</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=412\">SETVALUE,nomevar,valore[,durata] (NUMERI)</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=413\">SETONNEARBY,distanza,nome[,type][,cercacontenitori (true/false)]/proprietà/valore/...</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=414\">SETONPETS,distanza[,nome]/proprietà/valore/...</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=415\">SETONCARRIED,nomeitem[,itemtype][,equippato (true/false)]/proprietà/valore/...</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=416\">SETONSPAWN[,nomespawner],subgroup/proprietà/valore/...</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=417\">SETONSPAWNENTRY[,nomespawner],entrystring/proprietà/valore/...</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=418\">SETONPARENT/proprietà/valore/...</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=422\">FOREACH,objecttype[,nome][,distanza/nome regione]/azione (KILL,DAMAGE,SET etc)</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=423\">TAKEGIVE[,quantità[,cercainbanca (true/false),[type]]]/nomeitemdaprendere/GIVE/itemtypedadare</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=425\">GIVE[,probabilità (0.01=1% 1=100%)]/itemtypedadare</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=425\">GIVE[,probabilità (0.01=1% 1=100%)]/«itemtypedadare/proprietà/valore/...»</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=426\">TAKE[,probabilità (0.01=1% 1=100%)[,quantità[,cercainbanca (true/false)[,itemtype]]]]/nomeitem</A>\n" +
                "<A HREF=\"http://www.uoitalia.net/index.php?option=com_content&view=article&id=427\">TAKEBYTYPE[,probabilità (0.01=1% 1=100%)[,quantità[,cercainbanca (true/false)]]]/itemtype</A>\n" +
                "BROWSER/url\n" +
                "SENDMSG[,colore]/testo\n" +
                "SENDASCIIMSG[,colore][,numerofont]/testo (no accenti)\n" +
                "WAITUNTIL[,durata][,timeout][/condizione][/spawngroup]\n" +
                "WHILE/condizione/spawngroup\n" +
                "IF/condizione/thenspawn[/elsespawn] (a differenza del GOTOIF esegue immediatamente lo spawn!)\n" +
                "DESPAWN[,nomespawner],subgroup\n" +
                "SPAWN[,nomespawner],subgroup\n" +
                "GOTO/subgroup\n" +
                "GOTOIF/condizione/thensubgroup[/elsesubgroup]\n" +
                "COMMAND/stringa del comando (fate attenzione!)\n" +
                "MUSIC,nomemusica[,distanza]\n" +
                "SOUND,numerosuono\n" +
                "MEFFECT,itemid[,velocità][,x,y,z][,x2,y2,z2]\n" +
                "EFFECT,itemid,durata[,x,y,z] oppure EFFECT,itemid,durata[,trigmob]\n" +
                "SEFFECT,itemid,durata,velocità,colore,rendermode[,x,y,z] oppure SEFFECT,itemid,durata,velocità,colore,rendermode[,trigmob]\n" +
                "POISON,nomelivello[,distanza][,sologiocatori (true/false)]\n" +
                "DAMAGE,danno,fisico,fuoco,freddo,veleno,energia[,distanza][,sologiocatori (true/false)]\n" +
                "RESURRECT[,distanza][,pets (true/false)]\n" +
                "CAST,numerospell[,argomenti] o CAST,nomespell[,argomenti]\n" +
                "BCAST[,colore][,numerofont]/testo\n" +
                "BSOUND,numerosuono\n" +
                "GUMP,titolo,tipogump*[,gumpconstructor**]/testo;scelta1;valorescelta1;etcetc\n" +
                "*(0=messaggio - 1=si/no - 2=risposta scritta - 3=questgump - 4=risposta multipla)\n" +
                "** si può usare un metodo come costruttore o la parola KEYWORDS per usare la risposta come una chiave di qui sopra (GET/SET/ETC)",
                false, true);
            AddButton(width - 30, 5, 0x15E1, 0x15E5, 200, GumpButtonType.Page, 2);
            AddLabel(width - 38, 2, 0x384, "1");
            AddButton(width - 60, 5, 0x15E3, 0x15E7, 200, GumpButtonType.Page, 5);

            AddPage(2);
            AddLabel(27, 2, 0x384, "Value and Itemtype Keywords NB: ( « equivale a < ) ( » equivale a > )");
            AddHtml(25, 20, width - 10, 440,
                "ATTENZIONE, per tutti i GET* usando, nello spawner, la ^ (esempio {^GETONTRIGMOB/Location.x}) eseguirà tale comando DOPO che il mob/item viene spawnato, rendendo funzionante il GET* sul mob/item stesso, a differenza di quelli senza ^\n\n" +
                "proprietà/@valore\n\n" +
                "Special KeyWords\n" +
                ...
                "ITEM,seriale (per trovare quell'item)\n" +
                "SCROLL,cerchiominimo,cerchiomassimo\n" +
                "LOOT,nomemetodo\n" +
                "NECROSCROLL,index\n" +
                "LOOTPACK,loottype\n" +
                "POTION\n" +
                "TAKEN (serve per trovare gli item presi durante le transazioni quest, etc)\n" +
                "GIVEN (uguale a TAKEN, solo per gli item dati)\n" +
                "MULTIADDON,nomefile\n\n" +
                "{le keyword GET o RND si usano qui dentro}\n" +
                "RND,min,max\n" +
                "RNDBOOL\n" +
                "RNDLIST,int1[,int2,...]\n" +
                "RNDSTRLIST,str1[,str2,...]\n" +
                "MY,proprietà (per il mob appena spawnato)\n" +
                "GET,[nomeitem o seriale o SETITEM(*)][,itemtype],proprietà (*: il setitem dello spawner, si scrive SETITEM, MAIUSCOLO!)\n" +
                "GET,[nomeitem o seriale o SETITEM][,itemtype],«ATTACHMENT,type,name,property»\n" +
                "GETVAR,nomevar (XmlLocalVariable)\n" +
                "GETVALUE,nomevar (XmlValue)\n" +
                "GETONMOB,nomemob[,mobtype],proprietà\n" +
                "GETONMOB,nomemob[,mobtype],«ATTACHMENT,type,nome,proprietà»\n" +
                "GETONCARRIED,nomeitem[,itemtype][,equippedonly (true/false)],proprietà\n" +
                "GETONCARRIED,nomeitem[,itemtype][,equippedonly (true/false)],«ATTACHMENT,type,nome,proprietà»\n" +
                "GETONTRIGMOB,proprietà\n" +
                "GETONTRIGMOB,«ATTACHMENT,type,nome,proprietà»\n" +
                "GETONNEARBY,distanza,nome[,type][,cercacontenitori (true/false)],proprietà\n" +
                "GETONNEARBY,distanza,nome[,type][,cercacontenitori (true/false)],«ATTACHMENT,type,nome,proprietà»\n" +
                "GETONPARENT,proprietà\n" +
                "GETONPARENT,«ATTACHMENT,type,nome,proprietà»\n" +
                "GETONTHIS,proprietà\n" +
                "GETONTHIS,«ATTACHMENT,type,nome,proprietà»\n" +
                "GETONTAKEN,proprietà\n" +
                "GETONTAKEN,«ATTACHMENT,type,nome,proprietà»\n" +
                "GETONGIVEN,proprietà\n" +
                "GETONGIVEN,«ATTACHMENT,type,nome,proprietà»\n" +
                "GETONSPAWN[,nomespawner],subgroup,proprietà\n" +
                "GETONSPAWN[,nomespawner],subgroup,COUNT (speciale - ritorna il numero di oggetti spawnati!)\n" +
                "GETONSPAWN[,nomespawner],subgroup,«ATTACHMENT,type,nome,proprietà»\n" +
                "GETONSPAWNENTRY[,nomespawner],entrynumber,proprietà\n" +
                "GETFROMFILE,nomefile\n" +
                "GETACCOUNTTAG,nometag\n" +
                "MUL,valore o MUL,minimo,massimo (numeri frazionati)\n" +
                "INC,valore o INC,minimo,massimo (numeri interi)\n" +
                "MOB,nome[,mobtype] (cerca l'id di un dato mobile dal nome + eventuale tipo)\n" +
                "TRIGMOB\n" +
                "AMOUNTCARRIED,itemtype[,cercainbanca (true/false)][,itemname]\n" +
                "PLAYERSINRANGE,distanza\n" +
                "TRIGSKILL,name o value o base o cap\n" +
                "RANDNAME,nametype (female,male etc)\n" +
                "MUSIC,nomemusica[,distanza]\n" +
                "SOUND,valore\n" +
                "PRIVSOUND,valore (solo su singolo mob)\n" +
                "EFFECT,itemid,durata[,x,y,z]\n" +
                "SEFFECT,itemid,durata,velocità,colore,rendermode[,x,y,z]\n" +
                "BOLTEFFECT[,suono[,colore]]\n" +
                "MEFFECT,itemid[,velocità][,x,y,z][,x2,y2,z2]\n" +
                "PEFFECT,itemid,durata,[x,y,z]\n" +
                "POISON,livello[,distanza][,sologiocatori (true/false)]\n" +
                "DAMAGE,danno,fisico,fuoco,freddo,veleno,energia[,distanza][,sologiocatori (true/false)]\n" +
                "ADD[,probabilità (0.01=1% 1=100%)]/itemtype[,argomenti]\n" +
                "ADD[,probabilità (0.01=1% 1=100%)]/«itemtype[,argomenti]/proprietà/valore...»\n" +
                "EQUIP[,probabilità (0.01=1% 1=100%)]/itemtype[,argomenti]\n" +
                "EQUIP[,probabilità (0.01=1% 1=100%)]/«itemtype[,argomenti]/proprietà/valore...»\n" +
                "DELETE\n" +
                "KILL\n" +
                "UNEQUIP,layer[,delete (true/false)]\n" +
                "ATTACH[,probabilità (0.01=1% 1=100%)]/attachmenttype[,argomenti]\n" +
                "ATTACH[,probabilità (0.01=1% 1=100%)]/«attachmenttype[,argomenti]/proprietà/valore...»\n" +
                "MSG[,probabilità (0.01=1% 1=100%)]/testo\n" +
                "ASCIIMSG[,probabilità (0.01=1% 1=100%)][,colore][,numerofont]/testo\n" +
                "SENDMSG[,probabilità (0.01=1% 1=100%)][,colore]/testo\n" +
                "SENDASCIIMSG[,probabilità (0.01=1% 1=100%)][,colore][,numerofont]/testo\n" +
                "SAY[,probabilità (0.01=1% 1=100%)][,unhide (true of false - default false)]/testo\n" +
                "YELL[,probabilità (0.01=1% 1=100%)][,unhide (true of false - default false)]/testo\n" +
                "SPEECH[,probabilità (0.01=1% 1=100%)][,keywordnumber]\n" +
                "OFFSET,x,y,[,z]\n" +
                "ANIMATE,action[,framecount][,repeatcount][,forward true/false][,repeat true/false][,delay]\n" +
                "FACETO,x,y (gira il mobile con la faccia in direzione delle coordinate date)\n" +
                "EMOTE,numero (esegue una emote presente nel pannello [e - la 0 è la prima!)\n" +
                "SETVALUE,nomevar,valore[,durata] (NUMERI)\n" +
                "SETVAR,nomevar,valore[,durata] (STRINGHE)\n" +
                "FLASH,numero (1 fade black - 2 fade white - 3 light flash - 4 light to black flash - 5 black flash SOLO PG)\n" +
                "PRIVMSG[,probabilità (0.01=1% 1=100%)][,colore]/testo (mostra un messaggio solo a quel pg)\n" +
                "BCAST[,colore][,font]/messaggio\n" +
                "sempre...«ATTACHMENT,type,nome,proprietà» come proprietà nel GET\n" +
                "SKILL,nomeskill\n" +
                "STEALABLE,rubabile (true/false)",
                false, true);
            ...
            AddButton(width - 30, 5, 0x15E1, 0x15E5, 200, GumpButtonType.Page, 5);
            AddLabel(width - 41, 2, 0x384, "4");
            AddButton(width - 60, 5, 0x15E3, 0x15E7, 200, GumpButtonType.Page, 3);

            AddPage(5);
            AddLabel(27, 2, 0x384, "XMLSpawner linee spawn (ogni linea un comando/check, fine comando con ;)");
            AddHtml(25, 20, width - 10, 440,
                "#TILES,start[,end] spawn nei tileid all'interno del range indicato\n" +
                "#ITEMID,start[,end] come per TILES, ma valido sugli itemid (ITEM)\n" +
                "#NOTILES,start[,end] l'opposto di TILES (no spawn sui tileid indicati)\n" +
                "#NOITEMID,start[,end] l'opposto di ITEMID (no spawn su itemid indicati)\n" +
                "#WET spawn solo su tile ACQUA\n" +
                "#XFILL,inc spawn su riga X 1 elemento ogni 'inc'\n" +
                "#YFILL,inc come per XFILL ma su asse Y\n" +
                "#EDGE,inc come per XFILL ma sul perimetro spawn\n" +
                "#PLAYER,range spawn solo se è presente PG in range (trig)\n" +
                "#WAYPOINT,nome[,range] spawn su waypoint con nome UGUALE, range opzionale\n" +
                "#RELXY,xinc,yinc[,zinc] spawn su posizione XY[Z] relativa a coordinate fornite\n" +
                "#XY,xinc,yinc[,zinc] spawn su posizione esatta con incrementi\n" +
                "#DXY,xinc,yinc[,zinc] spawn su delta (spawn originale) con incrementi\n" +
                "#CONDITION,propertytest spawn con check su trigmob (triggerer) o spawn (this)\n",
                false, true);
            AddButton(width - 30, 5, 0x15E1, 0x15E5, 200, GumpButtonType.Page, 1);
            AddLabel(width - 41, 2, 0x384, "5");
    ...
    public class TextEntryGump : Gump
    {
            ...
            : base(X, Y)
        {
            ...
            string str = null;
            if (index < m_Spawner.SpawnObjects.Count)
            {
                ...
                if (origtext != null && oldtext != null && newtext != null)
                {
                    try
                    {
                        ...
                        if (firstindex >= 0)
                        {
                            ...
                            if (m_index < m_Spawner.SpawnObjects.Count)
                            {
                            ...
                            else
                            {
                                ...
                                m_Spawner.AddSpawnObjects(m_SpawnerGump.CreateArray(info, state.Mobile));
                            }
                        }
                    }
                    catch { }
    ...
    public class XmlSpawnerGump : Gump
    {
		...
		*/
            ...
            AddLabel(104, 428, 0x384, "Porta Qui");
            ...
            for (int i = 0; i < MaxSpawnEntries; ++i)
            {
                ...
                if (i < m_Spawner.SpawnObjects.Count)
                {
                    // disable button
        ...
        public List<XmlSpawner.SpawnObject> CreateArray(RelayInfo info, Mobile from)
        {
                ...
                if (te != null)
                {
                    ...
                    if (str.Length > 0)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                m_Spawner.SetStatusStr(string.Format("{0} is not a valid type name.", str));
                            }
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            if (m_Spawner == null || m_Spawner.Deleted || state == null || info == null || state.Account == null || state.Account.AccessLevel < AccessLevel.GameMaster)
            {
                if (m_Spawner != null)
                {
            ...
            // Update the creature list
            m_Spawner.AddSpawnObjects(CreateArray(info, state.Mobile));

            AllowGumpUpdate = true;

            for (int i = 0; i < m_Spawner.SpawnObjects.Count; ++i)
            {
                if (page != i / MaxEntriesPerPage)
                {
                    continue;
                ...
                if (m_ShowGump > 1)
                {
                    ...
                    if (subgroupindex >= 0 && subgroupindex < m_Spawner.SpawnObjects.Count)
                    {
                        ...
                        {
                            float grpval = 0;
                            try { grpval = Convert.ToSingle(tegrp.Text); }
                            catch { }
                            if (grpval < 0)
                            {
                                grpval = 0;
            ...
            switch (info.ButtonID)
            {
                ...
                {
                    m_Spawner.SetStatusStr(string.Empty);
                    break;
                }
                case 9997:
                {
                ...
                default:
                {
                            ...
                            if (info.ButtonID >= 800 && info.ButtonID < 800 + MaxSpawnEntries)
                    {
                        ...
                        XmlTextEntryBook book = new XmlTextEntryBook(1, string.Empty, m_Spawner.Name, 20, true, new XmlTextEntryBookCallback(ProcessSpawnerBookEntry), args);
                        ...
                        if (m_Spawner.SpawnObjects != null && index < m_Spawner.SpawnObjects.Count)
                        {
