...
namespace Server.Gumps
{
    public class XmlSetTimeSpanGump : Gump
    {
        ...
        private static int TotalHeight = OffsetSize + (7 * (EntryHeight + OffsetSize));
        ...
        public XmlSetTimeSpanGump(PropertyInfo prop, Mobile mobile, object o, Stack<PropertiesGump.StackEntry> stack, int page, List<PropertyObject> list) : base(GumpOffsetX, GumpOffsetY)
        {
            m_Property = prop;
            m_Mobile = mobile;
            m_Object = o;
