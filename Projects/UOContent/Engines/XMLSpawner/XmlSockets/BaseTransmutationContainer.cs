...
namespace Server.Items
{
    public class BaseTransmutationContainer : Container
    {
        ...
        private static List<BaseTransmutationContainer.Recipe> AllRecipes = new List<BaseTransmutationContainer.Recipe>();
        ...
        private class TransmuteEntry : ContextMenuEntry
        {
            ...
            private BaseTransmutationContainer m_Box;
            ...
            {
                if (m_From == null || m_Box == null || m_Box.Deleted)
                {
                    return;
                }
        ...
        private class TransmuteGump : Gump
        {
            ...
            public TransmuteGump(Mobile from, BaseTransmutationContainer target, Item lifted) : base(0, 0)
            {
                ...
                AddLabel((width >> 1) - 55, 15, TitleColor, target.Name);
                ...
                AddButton((width >> 1) - 43, height - 45, 0x1454, 0x1455, 1, GumpButtonType.Reply, 0); // Apply button
            }
