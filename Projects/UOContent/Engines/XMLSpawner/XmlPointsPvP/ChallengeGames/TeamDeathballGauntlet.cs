...
namespace Server.Items
{
    public class TeamDeathballGauntlet : BaseChallengeGame
    {
        ...
        private List<PlayerMobile> m_Organizers = new List<PlayerMobile>();
        ...
        public override List<PlayerMobile> Organizers { get { return m_Organizers; } }
        ...
        public override PlayerMobile Challenger { get{ return m_Challenger; } set { m_Challenger = value; } }
        ...
        public override List<BaseChallengeEntry> Participants { get{ return m_Participants; } set { m_Participants = value; } }
        ...
        public override void OnPlayerKilled(PlayerMobile killer, PlayerMobile killed)
        {
            ...
            if(m_DeathBall != null && m_DeathBall.RootParent is Corpse c)
            {
        ...
        public override bool AreChallengers(Mobile from, Mobile target)
        {
            ...
            if(m_Participants != null)
            {
                foreach(BaseChallengeEntry entry in m_Participants)
                {
                    if(!(entry.Status == ChallengeStatus.Active)) continue;
        ...
        public TeamDeathballGauntlet(PlayerMobile challenger) : base( 0x1414 )
        {
            ...
            {
                Name = $"Team DeathBall - Challenge by {challenger.Name}";
            }
        }
        ...
        public override void Deserialize( GenericReader reader )
        {
            ...
            {
            case 0:
                m_Challenger = reader.ReadMobile<PlayerMobile>();
