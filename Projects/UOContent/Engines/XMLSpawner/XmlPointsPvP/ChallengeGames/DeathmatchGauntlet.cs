...
namespace Server.Items
{
    public class DeathmatchGauntlet : BaseChallengeGame
    {
		...
		public override void CheckForGameEnd()
		{
            ...
            List<BaseChallengeEntry> winner = new List<BaseChallengeEntry>();

            int leftstanding = 0;
            BaseChallengeEntry lastentry = null;
            int maxscore = -99999;
            ...
            if(winner.Count > 0)
            {
                ...
                foreach(BaseChallengeEntry entry in winner)
                {
		...
		public void SubtractScore(BaseChallengeEntry entry)
		{
		...
		public void AddScore(BaseChallengeEntry entry)
		{
            if(entry == null) return;
		...
		public void RespawnWithPenalty(BaseChallengeEntry entry)
		{
            if(entry == null) return;
        ...
        public DeathmatchGauntlet(PlayerMobile challenger) : base( 0x1414 )
        {
            ...
            {
                Name = $"Deathmatch Gauntlet - Challenge by {challenger.Name}";
            }
        }
