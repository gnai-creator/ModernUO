...
namespace Server.Mobiles
{
    public class XmlQuestNPC : TalkingBaseCreature
    {
        ...
        [Constructable]
        public XmlQuestNPC() : this(-1, 1)
        {
        }

        public XmlQuestNPC(int gender) : this(-1, 1)
        {
        }

        [Constructable]
        public XmlQuestNPC(int gender, int dressed) : base(AIType.AI_Melee, FightMode.None, 10, 1, 0.8, 3.0)
        {
            SetStr(10, 30);
            SetDex(10, 30);
            SetInt(10, 30);
        ...
        //we don't need to backcall this...don't remove this override, or the mob can be deleted
