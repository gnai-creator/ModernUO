    ...
    public class XmlAddKarma : XmlAttachment
    {
        ...
        public override void OnAttach()
        {
            ...
            if (AttachedTo is PlayerMobile pm)
            {
                ...
                Misc.Titles.AwardKarma(pm, Value, false);
                //((Mobile)AttachedTo).Karma += Value;

                pm.SendLocalizedMessage(1005128, Value.ToString());
        ...
        public override void OnKilled(Mobile killed, Mobile killer, bool last)
        {
            ...
            killer.SendLocalizedMessage(1005128, Value.ToString());
        }


        public override LogEntry OnIdentify(Mobile from)
        {
            return new LogEntry(1005126, Value.ToString());
        }
    }
}
