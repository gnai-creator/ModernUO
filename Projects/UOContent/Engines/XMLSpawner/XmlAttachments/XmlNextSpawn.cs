...
namespace Server.Engines.XmlSpawner2
{
    public class XmlNextSpawn : XmlAttachment
    {
        ...
        [Attachable]
        public XmlNextSpawn(double mindelay, double maxdelay)
        {
        ...
        public static void ResetXmlSpawnTime(Mobile killed)
        {
            ...
            if (killed.Spawner is XmlSpawner spawner)
            {
