...
namespace Server.Mobiles
{
    public class XmlSpawnerSkillCheck
    {
        ...
        public static bool Mobile_SkillCheckLocation(Mobile from, SkillName skillName, float minSkill, float maxSkill)
        {
        ...
        public static bool Mobile_SkillCheckDirectLocation(Mobile from, SkillName skillName, float chance)
        {
            Skill skill = from.Skills[skillName];
        ...
        public static bool Mobile_SkillCheckTarget(Mobile from, SkillName skillName, object target, float minSkill, float maxSkill)
        {
            Skill skill = from.Skills[skillName];
        ...
        public static bool Mobile_SkillCheckDirectTarget(Mobile from, SkillName skillName, object target, float chance)
        {
            Skill skill = from.Skills[skillName];
        ...
        public class RegisteredSkill
        {
            ...
            public static List<XmlSpawnerSkillCheck.RegisteredSkill> TriggerList(SkillName index, Map map)
            {
                ...
                if (map == Map.DungeonSemiChiusi)
                {
                    maplist = m_DungeonSemiChiusiSkillList;
                }
                else
                if (map == Map.DungeonChiusi)
                {
                    maplist = m_DungeonChiusiSkillList;
                }
                else
                if (map == Map.Eventi)
                {
                    maplist = m_EventiSkillList;
                }
                /*else
if(map == Map.Malas)
